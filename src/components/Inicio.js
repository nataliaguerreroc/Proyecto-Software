      ...
      <div className = "inicio_cont">
        ...
        <div className = "contenedor-imagen">
          ...
          <div className = "buscador">
            <input type = "text" id = "busc" placeholder=" " className = "bar-buscador"/> <i class="fas fa-search"></i>
            <label for="busc" className ="form_buscar"> Buscar </label>
          </div>
...
function Card(props){
  ...
  return(
    <div className = "card">
      ...
      <button className = "card_btni" onClick = {() => {navigate('/sabermas');}}> Saber más</button>
      <button className = "card_btni" onClick = {() => {navigate('/experiencias');}}> Experiencias</button>
    </div>
  );
}
